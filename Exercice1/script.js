...
const afficheBtn = document.getElementById("affiche-btn") 
const hideBtn = document.getElementById("hide-btn")
const employers = document.getElementById("employees-tbody")



function affichemploye (){
    ...
    for (let i=0 ;i<employees.length;i++){
            ...
            div.innerHTML=`
                ...
                <p>${employees[i].position}</p>
                <p>${employees[i].salary}</p>
                <p>${employees[i].age}</p>
                <p>${employees[i].skills}</p>
                <p>${employees[i].joinDate}</p>
                
            `
            employers.appendChild(div);
    }
...
afficheBtn.addEventListener('click',function(){
    affichemploye()
    employers.classList.remove("hideen")

})
hideBtn.addEventListener('click',function(){
    employers.classList.add("hideen")
})
